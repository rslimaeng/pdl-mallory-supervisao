...
**Você ganha:** o Canvas de Oportunidades preenchido com a sua área — o mapa do que fazer com tudo que você aprendeu hoje — e um compromisso individual com dono, prazo e evidência.

**Você se compromete a:** preencher o Canvas com o grupo, apresentar em 3 minutos e assumir 1 tarefa real em voz alta.
...
| Você entra com | O que acontece | Você sai com |
|---|---|---|
| As oportunidades do M3, os prompts do M2 e M5, o protocolo do M4 | O grupo preenche o Canvas, prioriza pelo cruzamento impacto × facilidade e apresenta em 3 minutos | O Canvas da sua área e 1 tarefa real comprometida — em voz alta — para a próxima semana |

---

## Por que isso importa aqui dentro

Você já saiu de treinamento cheio de ideia e, três semanas depois, estava tudo igual. Não foi falta de vontade — foi falta de dono, prazo e jeito de cobrar. O Canvas existe para matar esse padrão: pega o que você mapeou e testou hoje e transforma em plano pequeno o bastante para acontecer.

A lógica é a mesma do PDCA que a Mallory já pratica há anos: planejar pequeno, executar, verificar, ajustar. Nada de "projeto de IA" — uma tarefa real, da sua rotina, com resultado observável na sexta-feira.

E o compromisso é dito em voz alta, para a turma, de propósito. O que você fala para 22 colegas tem outro peso — na segunda-feira, alguém vai perguntar "e aí, fez?". É esse empurrão que separa o plano da gaveta.
...
|---|---|---|---|
| Canvas de intenção | "Melhorar a comunicação com IA" — ninguém sabe o que fazer segunda | Escreveu objetivo, não tarefa | Reescreva na frase do M3: "toda semana a gente [tarefa]..." |
| Nota de vaidade | Tudo impacto 5, facilidade 5 — e nada acontece depois | Nota virou torcida, não avaliação | Justifique cada nota em 1 linha. Sem justificativa, desce 1 ponto |
| Compromisso de multidão | "O grupo vai testar" — e ninguém testa | Dono difuso é ausência de dono | Compromisso é individual: 1 nome, 1 tarefa, 1 evidência, 7 dias |
...
[← M5 · IA para Comunicação, Documentação e Análise](../m5/) · [Banco de Prompts →](../banco-de-prompts/)
