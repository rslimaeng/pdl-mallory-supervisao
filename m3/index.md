...
| 🟢 Boas candidatas a oportunidade | 🔴 Falsas candidatas |
|---|---|
| Tarefa que se repete toda semana no mesmo formato | Tarefa que acontece uma vez por ano — o ganho não paga o esforço |
| Transformar anotação bagunçada em documento padrão | Decisão que depende de estar na linha olhando a máquina |
| Resumir, extrair ou organizar informação que você já tem | Tarefa cujo insumo é dado sensível que não pode entrar no prompt |
| Primeira versão de qualquer texto que você revisa depois | Assinatura final de qualidade ou segurança — rascunho sim, aprovação nunca |
...
> - No exercício de hoje, **só dado fictício ou desidentificado**: troque nomes, números e códigos reais por inventados.
> - **Nunca envie:** nome de colega, parâmetro de molde ou máquina, dado de fornecedor — nem no treino.
> - A IA responde com confiança mesmo quando inventa — caso-âncora **Mata v. Avianca (2023)**: documentos criados pela IA, usados sem verificação, multa na Justiça.
> - Regra do módulo: mapear é livre; testar é com dado fictício; usar de verdade é depois da validação.
...
[← M2 · Primeiro Prompt: Mão na Massa](../m2/) · [M4 · Usando IA com Segurança →](../m4/)
